...
function V3D13_MosaicImpl(_weakMode) {
  ...
  this._mozWidth= 16*5/2;//int;
      ...
      //是两边空白的大小吗？
      _martigX=(UTItemManager.IMAGE_WIDTH-this._mosicRemderSize*this._mozWidth)*.5;//-_mosicRemderSize*.5;;
      _martigY=(UTItemManager.IMAGE_HEIGHT-this._mosicRemderSize*this._mozHeight)*.5;//-_mosicRemderSize*.5;;
      ...
      while(_LODLevel.length<this._mozWidth*this._mozHeight){
          _LODLevel.push(1);
      }
